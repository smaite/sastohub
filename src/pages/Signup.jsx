...
import { User, Mail, Lock, ArrowRight, ShoppingBag, ShieldCheck, Sparkles } from 'lucide-react';
      ...
      <div className="hidden lg:flex w-1/2 bg-[#0a0a0a] relative overflow-hidden flex-col justify-between p-12 xl:p-16 text-white">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-400 text-lg font-medium leading-relaxed mb-8 max-w-sm">
            Unlock access to thousands of verified vendors across Nepal.
          </p>
        ...
        <div className="w-full max-w-md mx-auto my-auto py-8 text-secondary">
          ...
          <form onSubmit={handleSignup} className="space-y-4 text-secondary">
            ...
            >
              {loading ? (
                ...
                <>AUTHORIZE SIGN UP <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" /></>
              )}
            </button>
          </form>
          ...
          <div className="relative py-6">
            ...
            <div className="relative flex justify-center text-[9px] uppercase font-black text-gray-300">
              <span className="bg-white px-4 tracking-[0.3em]">Direct Entry</span>
            </div>
          </div>
