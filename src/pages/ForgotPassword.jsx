    ...
    <div className="h-screen flex items-stretch bg-white font-sans text-surface-900 overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#0a0a0a] relative overflow-hidden flex-col justify-between p-12 xl:p-16">
        ...
        <div className="relative z-10">
          <h1 className="text-5xl xl:text-6xl font-black text-white leading-[1.1] mb-6 italic uppercase tracking-tighter">
            Secure Your <br />
            <span className="text-primary-600">Account</span> <br />
            Easily.
          </h1>
      ...
      <div className="flex-1 flex flex-col p-6 md:p-12 lg:p-16 bg-white overflow-y-auto">
        <div className="w-full max-w-md mx-auto my-auto py-8">
          <Link to="/login" className="inline-flex items-center gap-2 text-gray-400 hover:text-primary-600 transition-colors text-xs font-black uppercase tracking-widest mb-12 group">
            <ArrowLeft className="h-4 w-4 group-hover:-translate-x-1 transition-transform" /> Back to Sign In
          </Link>

          <div className="space-y-2 mb-8">
            <h2 className="text-3xl md:text-4xl font-black uppercase italic tracking-tighter text-surface-900">Account Recovery</h2>
          ...
          <form onSubmit={handleReset} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-surface-900 text-white py-4 rounded-[16px] font-black text-xs uppercase tracking-[0.3em] shadow-2xl shadow-secondary/30 hover:bg-black hover:-translate-y-0.5 active:translate-y-0 transition-all disabled:opacity-50 flex items-center justify-center gap-3 group mt-2"
            >
              {loading ? (
