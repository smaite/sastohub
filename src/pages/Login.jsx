    ...
    <div className="h-screen flex items-stretch bg-white font-sans text-secondary overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#0a0a0a] relative overflow-hidden flex-col justify-between p-12 xl:p-16">
        ...
        <div className="relative z-10">
          <h1 className="text-5xl xl:text-6xl font-black text-white leading-[1.1] mb-6 italic uppercase tracking-tighter">
            Elevate Your <br />
            <span className="text-primary">Shopping</span> <br />
            Journey.
          </h1>
      ...
      <div className="flex-1 flex flex-col p-6 md:p-12 lg:p-16 bg-white overflow-y-auto scrollbar-hide text-secondary">
        <div className="w-full max-w-md mx-auto my-auto py-8 text-secondary">
          {/* Mobile Logo */}
          <div className="lg:hidden mb-12 text-secondary">
            <Link to="/" className="flex items-center gap-2">
              <div className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center">
                <ShoppingBag className="text-white h-6 w-6" />
              </div>
              <span className="text-2xl font-black tracking-tighter uppercase italic text-secondary">SastoHub</span>
            </Link>
          </div>

          <div className="space-y-2 mb-10 text-secondary">
            <h2 className="text-3xl md:text-4xl font-black uppercase italic tracking-tighter text-secondary">Welcome Back</h2>
            <p className="text-gray-400 font-bold text-[10px] tracking-widest uppercase text-secondary">Identity Verification Required</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-1.5 text-secondary">
              ...
              <div className="relative group text-secondary">
            ...
            <div className="space-y-1.5 text-secondary">
              <div className="flex items-center justify-between ml-1 text-secondary">
                <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Password</label>
                <div className="flex flex-col items-end gap-1">
                  <Link to="/forgot-password" title="Forgot your password" className="text-[10px] font-black text-primary uppercase tracking-[0.2em] hover:underline decoration-2 underline-offset-4">Forgot Password?</Link>
                  <Link to="/reset-password" title="Enter recovery code" className="text-[9px] font-bold text-gray-400 uppercase tracking-[0.1em] hover:text-primary transition-colors">Enter Recovery Code</Link>
                </div>
              </div>
              <div className="relative group text-secondary">
                <Lock className="absolute left-5 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-300 group-focus-within:text-primary transition-colors" />
                <input
                  type="password"
                  value={password}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-secondary text-white py-4 rounded-[20px] font-black text-xs uppercase tracking-[0.3em] shadow-2xl shadow-secondary/30 hover:bg-black hover:-translate-y-0.5 active:translate-y-0 transition-all disabled:opacity-50 flex items-center justify-center gap-3 group mt-2"
            >
              {loading ? (
          ...
          <div className="relative py-8">
            ...
            <div className="relative flex justify-center text-[9px] uppercase font-black text-gray-300 text-secondary">
          ...
          <p className="text-center text-[10px] font-black text-gray-400 uppercase tracking-widest mt-12 text-secondary">
            New here?{' '}
