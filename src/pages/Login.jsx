      ...
      <div className="flex-1 flex flex-col p-6 md:p-12 lg:p-16 bg-white overflow-y-auto scrollbar-hide text-secondary">
        <div className="w-full max-w-md mx-auto my-auto py-8">
          ...
          <div className="space-y-2 mb-8 text-secondary">
            ...
            <p className="text-gray-400 font-bold text-[10px] tracking-widest uppercase">Identity Verification Required</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1.5 text-secondary">
              <div className="flex items-center justify-between ml-1">
                ...
                <Link to="/forgot-password" core="true" className="text-[10px] font-black text-primary uppercase tracking-[0.2em] hover:underline decoration-2 underline-offset-4">Reset?</Link>
              </div>
              <div className="relative group">
          ...
          <div className="relative py-6">
            ...
            <div className="relative flex justify-center text-[9px] uppercase font-black text-gray-300">
              <span className="bg-white px-4 tracking-[0.3em]">Quick Entry</span>
            </div>
          </div>
